    ...
    <nav class="navbar navbar-expand-lg bg-light shadow-lg">
        <div class="container">
            <a class="navbar-brand" href="acceuil.php">
                <img src="images/logoinptic.png" class="logo img-fluid" alt="Kind Heart Charity">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="concour.php">Concours</a>
                    </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12 mb-4">
                    <img src="images/logoinptic.png" class="logo img-fluid" alt="">
                </div>
