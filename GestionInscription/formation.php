                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block-wrap">
                            <img src="img/initiale1.jpg" class="custom-block-image img-fluid" alt="">

                            <div class="custom-block">
                                <div class="custom-block-body">
                                    <h5 class="mb-3">Formation Initiale 1</h5>
                                    <p></p>
                                </div>
                                <a href="" class="custom-btn btn"></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block-wrap">
                            <img src="img/initiale2.jpg" class="custom-block-image img-fluid" alt="">

                            <div class="custom-block">
                                <div class="custom-block-body">
                                    <h5 class="mb-3">Formation Initiale 2</h5>
                                    <p></p>
                                </div>
                                <a href="" class="custom-btn btn"></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="custom-block-wrap">
                            <img src="img/fp.jpg" class="custom-block-image img-fluid" alt="">

                            <div class="custom-block">
                                <div class="custom-block-body">
                                    <h5 class="mb-3">Formation Professionnelle</h5>
                                    <p></p>
                                </div>
                                <a href="" class="custom-btn btn"></a>
                            </div>
