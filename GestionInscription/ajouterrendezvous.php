...
<html>
  ...
  <body>
        ...
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-12 text-center">
            ...
            <div class="mb-5 element-animate">
              <h1>VOTRE RENDEZ-VOUS SERA VALIDE PAR LE MEDECIN</h1>
            </div>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="mb-5 text-center">MERCI POUR CETTE VISITE!</h2>
  ...
  if (isset($_POST['enregister'])) {
      ...
      $idp=htmlspecialchars($_POST['idp']);
	        $idmed=htmlspecialchars($_POST['idmed']);
     ...
     // if (!empty($nom) AND !empty($prenom) AND !empty($date2) AND !empty($sexe) AND !empty($telephone) AND !empty($mdp)) {
        $sql="INSERT INTO rendez_vous(idmedecin,idpatients,date,motif,statut) VALUES ('$idmed','$idp','$date2','$motif','$statut')";
        if (mysqli_query($conn,$sql)){
          $message="rendez-vous effectuée avec succes";
