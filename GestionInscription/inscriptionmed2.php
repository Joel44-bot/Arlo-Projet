...
<html>
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="">Mes Patient</a>
              </li>
                 <li class="nav-item">
                <a class="nav-link" href="">Medecin</a>
              </li>  
              <li class="nav-item cta">
                <a class="nav-link" href=""><span>S'inscrire</span></a>
              </li>
                 <li class="nav-item ">
	...
	<form enctype="multipart/form-data" class="contact-form" action="ajoutermedecin2.php" method="post" >
              <div class="row">
